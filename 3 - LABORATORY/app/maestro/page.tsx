import MaestroClient from '../components/MaestroClient';
        ...
        <div className="min-h-screen bg-slate-950 text-white">
            <div className="p-4 border-b border-slate-800/50 bg-slate-900/20 backdrop-blur-sm sticky top-0 z-50">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-bold uppercase tracking-wider">
                        Maestro v1.0
                    </div>
                </div>
            </div>
