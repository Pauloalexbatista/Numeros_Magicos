...
export class SistCombinadoMedia3System implements IPredictiveSystem {
    ...
    description = "Sistema costumizado: Média dos últimos 5 sorteios";
    ...
    async generateTop10(draws: Draw[]): Promise<number[]> {
        ...
        // Use last 5 draws for calculation (Standardized)
        const recentDraws = parsedDraws.slice(0, 5);
