...
async function check() {
    try {
        const p1 = await prodPrisma.systemPerformance.count({ where: { systemName: 'Diagonais da Matriz', game: 'TOTOLOTO' } });
        console.log('PROD TOTOLOTO Diagonais da Matriz (SystemPerformance):', p1);
    } catch(e) {
