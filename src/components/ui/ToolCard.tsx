...
export default function ToolCard({ href, icon, title, subtitle, tier, badge }: ToolCardProps) {
    ...
    const styles = {
        free: {
            container: "group flex flex-col items-center justify-center p-6 bg-card/50 backdrop-blur-sm rounded-xl shadow-sm border-2 border-emerald-200 dark:border-emerald-800 hover:border-emerald-400 dark:hover:border-emerald-600 transition-all hover:shadow-md",
            icon: "text-3xl mb-2 group-hover:scale-110 transition-transform",
            title: "font-semibold text-foreground",
            subtitle: "text-xs text-muted-foreground mt-1"
        },
        pro: {
            container: "group flex flex-col items-center justify-center p-6 bg-card/50 backdrop-blur-sm rounded-xl shadow-md border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 dark:hover:border-purple-500 transition-all hover:shadow-lg hover:scale-[1.02]",
            icon: "text-3xl mb-2 group-hover:scale-110 transition-transform",
            title: "font-semibold text-foreground",
            subtitle: "text-xs text-muted-foreground mt-1"
        },
        essential: {
            ...
            subtitle: "text-xs text-muted-foreground mt-2 text-center"
        }
    };
