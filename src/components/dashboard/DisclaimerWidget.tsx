...
export default function DisclaimerWidget() {
    return (
        <section className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950 dark:to-orange-950 p-6 rounded-xl border-2 border-yellow-300 dark:border-yellow-700 shadow-md">
