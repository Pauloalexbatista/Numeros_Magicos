    ...
    return (
        <div className="flex min-h-screen justify-center">
            ...
            <aside className="hidden 2xl:flex w-[300px] flex-col items-end pt-24 pr-6 fixed left-0 h-full z-0">
                <div className="w-[300px] h-[600px] bg-zinc-100 dark:bg-zinc-900/50 border border-border rounded-lg flex flex-col items-center justify-center text-zinc-400 text-xs gap-2">
