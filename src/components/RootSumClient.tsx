        ...
        return (
            <div className="bg-white dark:bg-zinc-900 rounded-xl p-8 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center justify-center">
                    ...
                    <p className="ml-4 text-zinc-600 dark:text-zinc-400">A calcular raízes digitais...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800">
                ...
                <div className="grid grid-cols-5 sm:grid-cols-10 gap-2">
                    {prediction.map((num) => (
                        <div
                            key={num}
                            className="aspect-square flex items-center justify-center rounded-lg font-bold text-lg bg-white dark:bg-zinc-800 border-2 border-orange-300 dark:border-orange-700 text-orange-700 dark:text-orange-300 shadow-sm hover:shadow-md transition-shadow"
                        >
                            {num}
                        </div>
                    ))}
