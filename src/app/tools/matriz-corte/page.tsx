...
export default function MatrizCortePage() {
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:text-slate-100">
            {/* Top Banner & Header */}
            <div className="relative overflow-hidden bg-white dark:bg-[#111827] border-b border-slate-200 dark:border-slate-800">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
                    ...
                    <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-3">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-amber-600 dark:from-indigo-400 dark:via-purple-400 dark:to-amber-400">
                            Matriz de Corte de Números
                        </span>
                    </h1>
                    <p className="text-base md:text-lg text-slate-600 dark:text-gray-400 max-w-3xl">
