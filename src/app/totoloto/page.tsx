...
export default async function TotolotoPage() {
    ...
    const latestDraw = totolotoDraws[0];

    const jackpotLeaders = await getJackpotLeaders('TOTOLOTO');
    const starJackpotLeaders = await getStarJackpotLeaders('TOTOLOTO');
    const rankings = await getRankingMetrics('TOTOLOTO');
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            Análises e previsões para o Totoloto
                        </p>
                    </div>
                </div>
