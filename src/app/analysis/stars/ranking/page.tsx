...
import { getStarSystemRanking, getStarJackpotLeaders } from '../actions';
...
export default async function StarRankingPage() {
    const rankings = await getStarSystemRanking();
        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 p-6">
            <div className="container mx-auto space-y-8 max-w-5xl">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/analysis/stars" className="p-2 rounded-lg bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition-colors">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-slate-400 text-lg">
                            Performance detalhada dos sistemas de previsão de estrelas.
                        </p>
                    </div>
                </div>
                ...
                <Card className="p-6 bg-gradient-to-br from-yellow-900/20 to-amber-900/10 border-yellow-500/20 backdrop-blur-sm">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-yellow-400">Caçadores de Estrelas</h2>
                                <p className="text-sm text-yellow-500/60">Sistemas com mais acertos perfeitos (2 estrelas)</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-400 mt-1">
                                                {(() => {
                                                    switch (rank.systemName) {
                                                        case 'Hot Stars':
                                                            return '🔥 Volume: As que saíram mais vezes (mesmo que há muito tempo).';
                                                        case 'Anti-Late Stars':
                                                            return '⚡ Recência: As que saíram há menos tempo (calor do momento).';
                                                        case 'Late Stars':
                                                            return '🧊 Atraso: As que não saem há mais tempo (devidas).';
                                                        case 'Anti-Hot Stars':
                                                            return '❄️ Raras: As que saíram menos vezes no total.';
                                                        case 'Markov Stars':
                                                            return '🔗 Transição: Baseado no que costuma sair a seguir à última.';
                                                        case 'Star Platinum':
                                                            return '💎 Ensemble: A melhor combinação de todos os sistemas.';
                                                        default:
                                                            return 'Sistema de previsão estatística avançada.';
                                                    }
                                                })()}
                                            </p>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-12">
                                        <div className="text-right">
                                            ...
                                            <div className={`text-3xl font-bold ${rank.avgAccuracy >= 20 ? 'text-emerald-400' :
                                                rank.avgAccuracy >= 10 ? 'text-yellow-400' : 'text-slate-400'
                                                }`}>
