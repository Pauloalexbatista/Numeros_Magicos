...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] flex flex-col md:flex-row relative overflow-hidden">
            ...
            <div className="w-full md:w-1/2 relative overflow-hidden flex flex-col justify-center p-8 md:p-12 bg-white border-r border-slate-200">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-[#F8F9FA]">
                <div className="max-w-2xl mx-auto w-full">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-[#2D3748] mb-3">Aviso Importante</h2>
                        <p className="text-amber-700 font-semibold">Jogo Responsável</p>
                    </div>
