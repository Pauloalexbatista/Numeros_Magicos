...
type WheelingMode = 'classic' | 'smart5' | 'magic';
...
export default function WheelingPage() {
    ...
    useEffect(() => {
        ...
        if (numbersParam) {
            const nums = numbersParam.split(',').map(n => parseInt(n.trim())).filter(n => n >= 1 && n <= 50);
            setSelectedNumbers(nums.slice(0, 25)); // Max 25
        }
    }, [searchParams]);
    ...
    const toggleNumber = (num: number) => {
        if (selectedNumbers.includes(num)) {
            ...
            if (selectedNumbers.length >= 25) return; // Hard limit
        ...
        try {
            ...
            if (mode === 'smart5') {
                ...
                if (selectedNumbers.length === 25) {
                    ...
                    alert('O Quadrado Mágico requer exatamente 25 números!');
                    setIsGenerating(false);
                }
            } else {
    ...
    const getModeDescription = () => {
        switch (mode) {
            ...
            case 'magic':
                return '12 chaves baseadas em Quadrado Mágico 5x5 - Propriedades matemáticas especiais';
            case 'classic':
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-8">
                            ...
                            {mode === 'magic' && (
                                <LogicExplanation title="Propriedades do Quadrado Mágico">
                                    <div className="space-y-4">
                                        <p>
                                            O <strong>Quadrado Mágico 5x5</strong> é uma disposição de 25 números onde a soma de cada linha,
                                            coluna e das duas diagonais principais é sempre a mesma (a "Constante Mágica").
                                        </p>
                            ...
                            <button
                                ...
                                disabled={selectedNumbers.length < 5 || isGenerating || (mode === 'magic' && selectedNumbers.length !== 25)}
            ...
            <div className="hidden print:block p-8 bg-white text-black">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-600">
                        Modo: {mode === 'smart5' ? 'Smart 5-Key' : mode === 'magic' ? 'Quadrado Mágico' : 'Clássico'}
                    </p>
                    <p className="text-sm text-gray-600">
