/**
 * Phase 2: EuroMillions STAR Systems
 * 
 * Recalculates historical predictions for 12 STAR systems
 * - 1917 draws × 12 systems = ~23,004 predictions
 * - Each prediction: 6 stars
 * 
 * Run with: npx tsx scripts/phase2-em-stars.ts
 */
...
async function main() {
    console.log('🔄 PHASE 2: EuroMillions STAR Systems\n');
